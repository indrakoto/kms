                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="text-muted small">People who started the most discussions on Talks.</p>
                            
                            <ul class="list-unstyled">
                                @foreach($topContributors as $contributor)
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset($contributor->photo ?: '/img/user-icon.png') }}" class="rounded-circle me-2" width="24" height="24" alt="Profile">
                                        <span>{{ $contributor->name }} 💹 {{ $contributor->threads_count }}</span>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
